...
<!-- 第一行 三块 -->
      ...
      <div class="con2">
         <div class="name">
         	<ul style="width:100%;height:36px;overflow:hidden">
         		<a href="#" target="_blank"><li id="one1" onmouseover="setTabsnow('one',1,3)" class="curnews">政策规章</li></a>
         		<li id="one2" onmouseover="setTabsnow('one',2,3)" >创新创业资讯</li>
   ...
   <!-- 第二行 三块 天天画div 问我的研究方向，画div呀，我就是研究画div-->
   <div id="second_con">
   </div>
