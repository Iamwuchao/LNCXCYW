	...
	margin-bottom: 0px;
			...
			<div class="modal-body" align="center">
				...
				<form id="exam_form" titleId>
					...
					<div style="display: none" class="option">
						<div class="form-inline form-group toc optionContent"
							id="optionLine">
		...
		<div id="emEvaModal" style="display: none;">
			...
			<div class="modal-body" align="center">
				...
				<form id="examEva_form">
					...
					<div style="display: none" class="evaOption">
						<div class="form-inline form-group toc evaOptionContent"
							id="evaOptionLine">
							<!-- <input type="checkbox" class="optionCheck"> -->
							<label for="evaOptionInput">评判标准:</label>
							<textarea class="form-control evaOptionInput" id="evaOptionInput"
								rows="3" cols="80" placeholder="评价描述"></textarea>
							<input type="number" class="form-control evaLowCheck"
								placeholder="分数段下限" id="evaLowCheck"> <input
								type="number" class="form-control evaHighCheck"
								placeholder="分数段上限" id="evaHighCheck">
							<button type="button" class="btn btn-primary"
								id="evaOptionRemove">移除</button>
						</div>
					</div>
					<br>
				</form>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-default" id="closeEva"
					data-dismiss="modal">关闭</button>
		...
		<div id="emPaperModal" style="display: none;">
				...
				<form id="examPaper_form">
					...
					<div style="display: block" class=emPaper>
						<div class="form-inline form-group toc evaOptionContent"
							id="evaOptionLine">
							<!-- <input type="checkbox" class="optionCheck"> -->
							<label for="paperNameInput">试卷名称:</label> <input type="text"
								class="form-control paperNameInput" style="width: 520px"
								id="paperNameInput" placeholder="试卷名称" /> <br> <br> <label
								for="paperDescInput">试卷描述:</label>
							<textarea class="form-control paperDescInput" id="paperDescInput"
								rows="3" cols="80" placeholder="试卷描述"></textarea>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-default" id="closePaper"
					data-dismiss="modal">关闭</button>
		...
		<script>
					...
					function() {
						...
						$(optionList).each(
								function() {
									...
									$(cntOption).find(".optionInput").val(
											$(this).attr("optionText"));
									/* if(isRight == "true")
									{				
					...
					.on(
							...
							function() {
								var checkList = document
										.getElementsByClassName("optionContent");
								for (var i = 0; i < checkList.length; ++i) {
									alert(checkList[i]
											.getElementsByClassName("optionCheck")[0].checked);
								}
							})
			...
			$(document).on(
					...
					function() {
						var paperCatogery = $(
								"#categoryListSel option:selected").val();
						alert(paperCatogery);
						$.ajax({
							url : 'examPreshow',
							type : 'post',
