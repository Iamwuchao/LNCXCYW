...
<layout:override name="menu_list">
	 ...
	 <div class="menu-list" style="height:820px"> 
	     <a href="#" class="menu-button-middle"><span class="glyphicon glyphicon-blackboard">&nbsp;新闻分类</span></a>
	    <a href="#" class="menu-button-middle"><span class="glyphicon glyphicon-th-large">&nbsp;新闻管理</span></a>
